...
round budget presumes a fleet phase with task branches; on a solo gate, only the reporting rule at
the end of this skill applies — a PASS reached after N rounds of fixes is still reported as such.
